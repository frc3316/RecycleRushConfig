...
public class Config {
	...
	private void initConfig() {
		 ...
		 * Robot A
		 */
		addToConstantsA("CHASSIS_ENCODER_LEFT_DISTANCE_PER_PULSE",
				((6 * Math.PI) / 32) * 0.0254);
		addToConstantsA("CHASSIS_ENCODER_RIGHT_DISTANCE_PER_PULSE",
				((6 * Math.PI) / 32) * 0.0254);
		addToConstantsA("CHASSIS_ENCODER_CENTER_DISTANCE_PER_PULSE",
				((4 * Math.PI) / 32) * 0.0254);

		/*
		 * Robot B
		 */
		addToConstantsB("CHASSIS_ENCODER_LEFT_DISTANCE_PER_PULSE",
				((6 * Math.PI) / 32) * 0.0254);
		addToConstantsB("CHASSIS_ENCODER_RIGHT_DISTANCE_PER_PULSE",
				((6 * Math.PI) / 32) * 0.0254);
		addToConstantsB("CHASSIS_ENCODER_CENTER_DISTANCE_PER_PULSE",
				((4 * Math.PI) / 32) * 0.0254);
		...
		addToVariables("chassis_HeadingToSet", 0.0); // This is the heading that
														// the SetHeadingSDB
														// command sets to
		...
		// PIDRotation
		addToVariables("chassis_RobotOrientedDrivePIDRotation_UsePIDRotation",
				true);
		addToVariables(
				"chassis_RobotOrientedDrivePIDRotation_PIDControllerRotation_KP",
				5.2);
		addToVariables(
				"chassis_RobotOrientedDrivePIDRotation_PIDControllerRotation_KI",
				0.0);
		addToVariables(
				"chassis_RobotOrientedDrivePIDRotation_PIDControllerRotation_KD",
				6.0);

		addToVariables(
				"chassis_RobotOrientedDrivePIDRotation_PIDControllerRotation_AbsoluteTolerance",
				0.0);

		addToVariables(
				"chassis_RobotOrientedDrivePIDRotation_PIDControllerRotation_MinimumOutput",
				-1.0);
		addToVariables(
				"chassis_RobotOrientedDrivePIDRotation_PIDControllerRotation_MaximumOutput",
				1.0);

		addToVariables("chassis_RobotOrientedDrivePIDRotation_SetpointScale",
				360.0);

		// RobotOrientedNavigation

		// Set 1 - To push container out of the way
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KP_1",
				300.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KI_1",
				2.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KD_1",
				2.0);

		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KP_1",
				500.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KI_1",
				2.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KD_1",
				2.0);
		...
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KP_2",
				300.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KI_2",
				2.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KD_2",
				2.0);

		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KP_2",
				3000.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KI_2",
				2.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KD_2",
				2.0);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_KP_2",
				3.8);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_KI_2",
				0.045);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_KD_2",
				0.82);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerX_AbsoluteTolerance_2",
				0.15);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerY_AbsoluteTolerance_2",
				0.05);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_AbsoluteTolerance_2",
				5.0);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerX_MinimumOutput_2",
				-0.6);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerX_MaximumOutput_2",
				0.6);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerY_MinimumOutput_2",
				-0.6);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerY_MaximumOutput_2",
				0.6);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_MinimumOutput_2",
				-0.5);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_MaximumOutput_2",
				0.5);
		...
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KP_3",
				300.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KI_3",
				2.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KD_3",
				2.0);

		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KP_3",
				200.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KI_3",
				2.2);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KD_3",
				1.5);
		...
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KP_4",
				200.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KI_4",
				2.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerX_KD_4",
				1.0);

		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KP_4",
				200.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KI_4",
				4.0);
		addToVariables("chassis_RobotOrientedNavigation_PIDControllerY_KD_4",
				1.0);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_KP_4",
				1.5);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_KI_4",
				0.01);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_KD_4",
				0.101);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerX_AbsoluteTolerance_4",
				0.2);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerY_AbsoluteTolerance_4",
				0.6);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_AbsoluteTolerance_4",
				20.0);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerX_MinimumOutput_4",
				-0.6);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerX_MaximumOutput_4",
				0.6);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerY_MinimumOutput_4",
				-0.6);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerY_MaximumOutput_4",
				0.6);

		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_MinimumOutput_4",
				-0.5);
		addToVariables(
				"chassis_RobotOrientedNavigation_PIDControllerHeading_MaximumOutput_4",
				0.5);
