...
{	
	...
	private void initConfig ()
	{
		 ...
		 */
			...
			addToVariables("chassis_RobotOrientedNavigation_PIDControllerS_KP", 500.0);
			...
			addToVariables("chassis_RobotOrientedNavigation_PIDControllerF_KP", 500.0);
			...
			addToVariables("chassis_RobotOrientedNavigation_PIDControllerTurn_KP", 500.0);
